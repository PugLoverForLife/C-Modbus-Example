...
//#include <crc16.h> This causes problems for no reason
...
class ModbusMaster
{
  public:
    ...
    */
    ...
    uint8_t _u8ResponseBufferLength; // Because otherwise, how are we supposed to know how long the buffer is?
